...
class VaribadVAEMixtureExt:
    ...
    def compute_loss(self, latent_mean, latent_logvar, vae_prev_obs, vae_next_obs, vae_actions,
        ...
        return rew_reconstruction_loss, state_reconstruction_loss, task_reconstruction_loss, loss_gauss, loss_cat, loss_ext
    ...
    def compute_vae_loss(self, update=False, pretrain_index=None):
        ...
        if self.args.split_batches_by_task:
            ...
            losses = self.compute_loss(latent_mean, latent_logvar, vae_prev_obs, vae_next_obs, vae_actions,
                                       vae_rewards, vae_tasks, trajectory_lens, y, z, mu, var, logits, prob, output)
        rew_reconstruction_loss, state_reconstruction_loss, task_reconstruction_loss, gauss_loss, cat_loss, ext_loss = losses
        ...
        self.log(elbo_loss, rew_reconstruction_loss, state_reconstruction_loss, task_reconstruction_loss, gauss_loss, cat_loss, ext_loss, pretrain_index)


        return elbo_loss

    def log(self, elbo_loss, rew_reconstruction_loss, state_reconstruction_loss, task_reconstruction_loss, gauss_loss, cat_loss, ext_loss, pretrain_index=None):
