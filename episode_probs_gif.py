...
for seed in seed_list:
    for dir in listdirs_ml10:
        if ('varibad_10__22:08_17:26:22' in dir) or ('varibad_11__22:08_17:26:54' in dir) or ('varibad_12__22:08_17:28:14' in dir) or ('varibad_13__22:08_17:27:08' in dir):
            dir_ml10.append(dir)
print(dir_ml10)
...
for seed in range(len(seed_list)):
    for iter in range(len(iter_list)):
        ...
        for i in range(500):
            ...
            sns.heatmap(np.flip(np.transpose(heatmap_data),0), ax=axes[1], vmin=0, vmax=1.0, annot=True, fmt='.2f', cmap = 'viridis', cbar=False, xticklabels=range(1, 16),yticklabels=range(class_num, 0, -1))
