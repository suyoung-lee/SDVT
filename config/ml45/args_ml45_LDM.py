...
def get_args(rest_args):
    ...
    parser.add_argument('--exp_label', default='LDM', help='label (typically name of method)')
    ...
    # --- Virtual ---
    parser.add_argument('--virtual_ratio', type=float, default=0.1, help='virtual training ratio')
    parser.add_argument('--virtual_ratio_increment', type=float, default=0.00, help='virtual ratio increased per 100M steps')
    parser.add_argument('--num_virtual_skills', type=int, default=10)
