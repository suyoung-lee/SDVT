...
def get_args(rest_args):
    ...
    parser.add_argument('--exp_label', default='SDVT', help='label (typically name of method)')
    ...
    #Gaussian mixture
    parser.add_argument('--vae_mixture_num', type=int, default=45,
    ...
    parser.add_argument('--virtual_ratio_increment', type=float, default=0.025, help='virtual ratio increased per 100M steps')
